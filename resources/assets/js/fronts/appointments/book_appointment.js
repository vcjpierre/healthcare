                ...
                if (result.success) {
                    ...
                    $("#FrontAppointmentServiceId").append(
                        $('<option value=""></option>').text(
                            Lang.get("messages.common.select_service")
                        )
                    );
...
listenSubmit("#frontAppointmentBook", function (e) {
    ...
    if (!$("#isPatientAccount").is(":checked")) {
        if (firstName == "") {
            response =
                '<div class="gen alert alert-danger">' +
                Lang.get("messages.common.first_name_required") +
                "</div>";
        ...
        if (lastName == "") {
            response =
                '<div class="gen alert alert-danger">' +
                Lang.get("messages.common.last_name_required") +
                "</div>";
            $(window).scrollTop($(".appointment-form").offset().top);
            $(".book-appointment-message")
                .html(response)
    ...
    if (email == "") {
        response =
            '<div class="gen alert alert-danger">' +
            Lang.get("messages.common.email_required") +
            "</div>";
    ...
    if (doctor == "") {
        response =
            '<div class="gen alert alert-danger">' +
            Lang.get("messages.common.doctor_required") +
            "</div>";
        $(".book-appointment-message").html(response).delay(5000).hide("slow");
        $(window).scrollTop($(".appointment-form").offset().top);
        return false;
    ...
    if (services == "") {
        response =
            '<div class="gen alert alert-danger">' +
            Lang.get("messages.common.service_required") +
            "</div>";
        $(".book-appointment-message").html(response).delay(5000).hide("slow");
        $(window).scrollTop($(".appointment-form").offset().top);
        return false;
    ...
    if (appointmentDate == "") {
        response =
            '<div class="gen alert alert-danger">' +
            Lang.get("messages.common.appointment_date_required") +
            "</div>";
        $(".book-appointment-message").html(response).delay(5000).hide("slow");
        $(window).scrollTop($(".appointment-form").offset().top);
        return false;
    ...
    if (paymentType == "") {
        response =
            '<div class="gen alert alert-danger">' +
            Lang.get("messages.common.payment_type_required") +
            "</div>";
        $(".book-appointment-message").html(response).delay(5000).hide("slow");
        $(window).scrollTop($(".appointment-form").offset().top);
        return false;
    ...
    let response =
        ...
        Lang.get("messages.common.processing") +
        "</div>";

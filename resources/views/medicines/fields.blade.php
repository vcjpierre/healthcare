...
<div class="form-group col-md-6 mb-5">
    ...
    <span class="required"></span>
    {{ Form::select('category_id', $categories, (isset($medicine)) ? $medicine->category_id : null, ['class' => 'form-select', 'placeholder' => __('messages.common.select_category'), 'id' => 'medicineCategoryId']) }}
</div>

    ...
    <div class="col-md-12">
        <div class="d-flex justify-content-end">
            <div class="d-flex align-items-center">
                ...
                <span class="me-4">{{__(\App\Models\Appointment::STATUS[1])}}</span>
                <span class="badge bg-success badge-circle me-1 slot-color-dot"></span>
                <span class="me-4">{{__(\App\Models\Appointment::STATUS[2])}}</span>
                <span class="badge bg-warning badge-circle me-1 slot-color-dot"></span>
                <span class="me-4">{{__(\App\Models\Appointment::STATUS[3])}}</span>
                <span class="badge bg-danger badge-circle me-1 slot-color-dot"></span>
                <span class="me-4">{{__(\App\Models\Appointment::STATUS[4])}}</span>
            </div>
        </div>
    </div>
</div>

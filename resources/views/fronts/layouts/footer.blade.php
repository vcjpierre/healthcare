    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-4 col-md-6 order-1 order-lg-0">
                <h5 class="text-white mb-4 pb-1">Contacto</h5>
            ...
            <div class="col-lg-4 col-md-6 order-2 order-lg-2">
                <h5 class="text-white mb-4 pb-1">Enlaces</h5>
                <ul>
                    <li>
                        <a href="{{ route('medicalAboutUs') }}"
                           class="text-decoration-none  mb-2 d-block fw-light {{ Request::is('medical-about-us*') ? 'text-black' : 'text-white' }}">Sobre nosotros</a>
                    </li>
                    <li>
                        <a href="{{ route('medicalContact') }}"
                           ...
                           data-turbo="false">Contactanos</a>
                    </li>
                </ul>
            </div>
            <div class="col-lg-4 col-12 order-0 order-lg-3 mb-4 mb-lg-0">
                <h5 class="text-white mb-4 pb-1">Suscribirse</h5>
                <div class="footer-subcribe">
                    ...
                    <div class="subscribeForm-message"></div>
                        <div class="input-group mb-md-3">
                            {{ Form::email('email',null, ['class' => 'form-control form-control-transparent','id'=>'email', 'placeholder' => __('Ingresa tu email'), 'required']) }}

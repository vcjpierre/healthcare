<div class="row">
    ...
    <div class="col-lg-6">
        <div class="form-group">
            <label class="form-label" for="templateAppointmentDate">{{ __('messages.appointment.appointment_date') }}:
    ...
    <div class="text-center col-12">
        <p class="text-uppercase mb-sm-4 mb-0 d-none" id="payableAmountText">
            {{ __('messages.appointment.payable_amount') }} : <span class="fw-bold"
...
<script>
    ...
    $(document).ready(function () {             
        $('#frontAppointmentBook').on('submit', function (e) {
            ...
            $.ajax({
                type: 'POST',
                url: '{{ route('front.appointment.book') }}',
                data: $(this).serialize(),
